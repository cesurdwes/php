  ...
  <body>
    <header>
      <div class="navegacion">
        ...
        <a id="activo" class="navegacion_izquierda texto_navegacion" onclick="location.href = 'actoresTemp.php'">Actores por Episodio</a>
      </div>
    </header>
      <fieldset>
        <?php
...
//Llamamos al fichero que contiene la conexión
          ...
          echo "<legend><b>Listado de actores por Temporada</b></legend>";

          //Obtenemos los Resultados
          $listado_actores = $tronos->devolverListadoActoresPorTemporada();
          ...
          if($listado_actores!=null){
            ...
            echo "<tr><th>Nombre Real</th><th>Nombre en la Serie</th><th>Episodio</th><th>Temporada</th></tr>";
            foreach ($listado_actores as $actor) {
              echo "<tr><td>".$actor['name']."</td><td>".
                $actor['serie_name']."</td><td>".$actor['episode']."</td>
                  <td>".$actor['season']."</td></tr>";
            }
            echo "</table>";
          }
          else{
