      ...
      <fieldset>
        ...
        if(isset($_POST['nombre']) && !is_null($_POST['nombre'])
          && isset($_POST['ciudad']) && !is_null($_POST['ciudad'])
            ...
            echo "<legend><b>Datos del nuevo equipo insertado</b></legend>";

            //Insertamos el equipo y lo almacenamos en memoria
            $equipo = $bbdd->insertarEquipo($nombre_equipo,$ciudad_equipo,$conferencia_equipo,$division_equipo);
